            ...
            {navigation.map((item) => (
              ...
              >
                ...
                {item.megaMenu && activeDropdown === item.name && (
                  <div className="absolute inset-x-0 top-full shadow-lg z-50 bg-white border-t border-pantanal-green-900/10">
                    <div className="mx-auto max-w-[1440px] px-8 grid md:grid-cols-3 gap-x-16 gap-y-10 py-12">
                      {/* Coluna 1: Lodge */}
                      <div>
