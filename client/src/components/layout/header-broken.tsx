              ...
              >
                ...
                {item.megaMenu && activeDropdown === item.name && (
                  <div className="absolute inset-x-0 top-full z-40">
                    <div className="mx-auto max-w-[1440px] px-8 py-12 bg-white rounded-md shadow-[0_2px_4px_rgba(0,0,0,0.05)] grid grid-cols-1 md:grid-cols-3 gap-x-16 gap-y-8" role="navigation">
                        {/* Coluna 1: Lodge */}
                        <div>
